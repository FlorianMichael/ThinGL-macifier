...
public class MutableBuffer extends Buffer {
    ...
    public void initialize(final long size, final int usage) {
        ...
        de.florianmichael.thingl.GlCommands.get().glNamedBufferData(this.getGlId(), size, usage);
    }
    ...
    public void initialize(final ByteBuffer dataBuffer, final int usage) {
        ...
        this.parameters.clear();
        de.florianmichael.thingl.GlCommands.get().glNamedBufferData(this.getGlId(), dataBuffer, usage);
    }
