...
public abstract class ImageTexture extends Texture implements ImageStorage {
    ...
    protected void uploadPixels(final int level, final int x, final int y, final int z, final int width, final int height, final int depth, final int pixelFormat, final ByteBuffer pixelBuffer) {
        ...
        if (this instanceof ImageStorage2D) {
            ...
            de.florianmichael.thingl.GlCommands.get().glTextureSubImage2D(this.getGlId(), level, x, y, width, height, pixelFormat, GL11C.GL_UNSIGNED_BYTE, pixelBuffer);
        } else if (this instanceof ImageStorage3D) {
            de.florianmichael.thingl.GlCommands.get().glTextureSubImage3D(this.getGlId(), level, x, y, z, width, height, depth, pixelFormat, GL11C.GL_UNSIGNED_BYTE, pixelBuffer);
            ...
            de.florianmichael.thingl.GlCommands.get().glTextureSubImage1D(this.getGlId(), level, x, width, pixelFormat, GL11C.GL_UNSIGNED_BYTE, pixelBuffer);
        } else {
    ...
    protected ByteBuffer downloadPixelBuffer(final int level, final int x, final int y, final int z, final int width, final int height, final int depth, final int pixelFormat) {
        ...
        de.florianmichael.thingl.GlCommands.get().glGetTextureSubImage(this.getGlId(), level, x, y, z, width, height, depth, pixelFormat, GL11C.GL_UNSIGNED_BYTE, pixelBuffer);
        ThinGL.glStateStack().popPixelStore();
        return pixelBuffer;
    }
    ...
    public void clear(final int level, final Color color) {
        if (!color.equals(Color.TRANSPARENT)) {
            de.florianmichael.thingl.GlCommands.get().glClearTexImage(this.getGlId(), level, GL11C.GL_RGBA, GL11C.GL_FLOAT, color.toRGBAF());
        } else {
            de.florianmichael.thingl.GlCommands.get().glClearTexImage(this.getGlId(), level, GL11C.GL_RGBA, GL11C.GL_UNSIGNED_BYTE, (ByteBuffer) null);
        }
    }
    ...
    protected void clear(final int level, final int x, final int y, final int z, final int width, final int height, final int depth, final Color color) {
        if (!color.equals(Color.TRANSPARENT)) {
            de.florianmichael.thingl.GlCommands.get().glClearTexSubImage(this.getGlId(), level, x, y, z, width, height, depth, GL11C.GL_RGBA, GL11C.GL_FLOAT, color.toRGBAF());
        } else {
            de.florianmichael.thingl.GlCommands.get().glClearTexSubImage(this.getGlId(), level, x, y, z, width, height, depth, GL11C.GL_RGBA, GL11C.GL_UNSIGNED_BYTE, (ByteBuffer) null);
        }
    }
    ...
    public void copyTo(final ImageStorage target, final int srcLevel, final int srcX, final int srcY, final int srcZ, final int dstLevel, final int dstX, final int dstY, final int dstZ, final int width, final int height, final int depth) {
        de.florianmichael.thingl.GlCommands.get().glCopyImageSubData(this.getGlId(), this.getTarget(), srcLevel, srcX, srcY, srcZ, target.getGlId(), target.getTarget(), dstLevel, dstX, dstY, dstZ, width, height, depth);
    }
    ...
    public int getParameterInt(final int parameter) {
        ...
        if (!(value instanceof Integer)) {
            if (parameter == GL45C.GL_TEXTURE_TARGET && ThinGL.workarounds().isGetTextureParameterTextureTargetBroken()) {
                ...
                value = de.florianmichael.thingl.GlCommands.get().glGetTextureParameteri(this.getGlId(), parameter);
            }
    ...
    public void setParameterInt(final int parameter, final int value) {
        if (this.getParameterInt(parameter) != value) {
            ...
            de.florianmichael.thingl.GlCommands.get().glTextureParameteri(this.getGlId(), parameter, value);
        }
    }
    ...
    public float getParameterFloat(final int parameter) {
        ...
        if (!(value instanceof Float)) {
            value = de.florianmichael.thingl.GlCommands.get().glGetTextureParameterf(this.getGlId(), parameter);
            this.parameters.put(parameter, value);
        }
        return (float) value;
    }
    ...
    public void setParameterFloat(final int parameter, final float value) {
        if (this.getParameterFloat(parameter) != value) {
            ...
            de.florianmichael.thingl.GlCommands.get().glTextureParameterf(this.getGlId(), parameter, value);
        }
    }
    ...
    public int[] getParameterIntArray(final int parameter, final int length) {
        ...
        if (!(value instanceof int[] && ((int[]) value).length == length)) {
            ...
            de.florianmichael.thingl.GlCommands.get().glGetTextureParameteriv(this.getGlId(), parameter, (int[]) value);
            this.parameters.put(parameter, value);
        }
        return (int[]) value;
    }
    ...
    public void setParameterIntArray(final int parameter, final int[] value) {
        if (!Arrays.equals(this.getParameterIntArray(parameter, value.length), value)) {
            ...
            de.florianmichael.thingl.GlCommands.get().glTextureParameteriv(this.getGlId(), parameter, value);
        }
    }
    ...
    public float[] getParameterFloatArray(final int parameter, final int length) {
        ...
        if (!(value instanceof float[] && ((float[]) value).length == length)) {
            ...
            de.florianmichael.thingl.GlCommands.get().glGetTextureParameterfv(this.getGlId(), parameter, (float[]) value);
            this.parameters.put(parameter, value);
        }
        return (float[]) value;
    }
    ...
    public void setParameterFloatArray(final int parameter, final float[] value) {
        if (!Arrays.equals(this.getParameterFloatArray(parameter, value.length), value)) {
            this.parameters.put(parameter, value.clone());
            de.florianmichael.thingl.GlCommands.get().glTextureParameterfv(this.getGlId(), parameter, value);
        }
    }
