...
public class Framebuffer extends GLContainerObject {
    ...
    public Framebuffer() {
        super(de.florianmichael.thingl.GlCommands.get().glCreateFramebuffers());
    ...
    public void checkStatus() {
        final int status = de.florianmichael.thingl.GlCommands.get().glCheckNamedFramebufferStatus(this.getGlId(), GL30C.GL_FRAMEBUFFER);
        switch (status) {
    ...
    public void clearColor(final Color color, final boolean red, final boolean green, final boolean blue, final boolean alpha) {
        if (this.getColorAttachment(0) != null) {
            ...
            de.florianmichael.thingl.GlCommands.get().glClearNamedFramebufferfv(this.getGlId(), GL11C.GL_COLOR, 0, color.toRGBAF());
    ...
    public void clearDepth(final float depth) {
        if (this.getDepthAttachment() != null) {
            ...
            de.florianmichael.thingl.GlCommands.get().glClearNamedFramebufferfv(this.getGlId(), GL11C.GL_DEPTH, 0, new float[]{depth});
    ...
    public void clearStencil(final int stencil, final int mask) {
        if (this.getStencilAttachment() != null) {
            ...
            de.florianmichael.thingl.GlCommands.get().glClearNamedFramebufferiv(this.getGlId(), GL11C.GL_STENCIL, 0, new int[]{stencil});
    ...
    public void clearDepthAndStencil(final float depth, final int stencil) {
        if (this.getDepthAttachment() != null && this.getStencilAttachment() != null) {
            ...
            de.florianmichael.thingl.GlCommands.get().glClearNamedFramebufferfi(this.getGlId(), GL30C.GL_DEPTH_STENCIL, 0, depth, stencil);
            ThinGL.glStateStack().popStencilMask();
            ThinGL.glStateStack().popDepthMask();
            ThinGL.glStateStack().pop();
    ...
    public void blitTo(final Framebuffer target, final boolean color, final boolean depth, final boolean stencil) {
        ...
        de.florianmichael.thingl.GlCommands.get().glBlitNamedFramebuffer(this.getGlId(), target.getGlId(), 0, 0, this.getWidth(), this.getHeight(), 0, 0, target.getWidth(), target.getHeight(), mask, GL11C.GL_NEAREST);
    }
    ...
    public ImageStorage getAttachment(final int attachmentPoint) {
        if (!this.attachments.containsKey(attachmentPoint)) {
            final int attachmentType = de.florianmichael.thingl.GlCommands.get().glGetNamedFramebufferAttachmentParameteri(this.getGlId(), attachmentPoint, GL30C.GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE);
            if (attachmentType == GL11C.GL_NONE) {
                this.attachments.put(attachmentPoint, null);
                return null;
            }

            final int attachmentGlId = de.florianmichael.thingl.GlCommands.get().glGetNamedFramebufferAttachmentParameteri(this.getGlId(), attachmentPoint, GL30C.GL_FRAMEBUFFER_ATTACHMENT_OBJECT_NAME);
    ...
    public void setAttachment(final int attachmentPoint, final ImageStorage attachment) {
        ...
        if (attachment instanceof ImageTexture) {
            de.florianmichael.thingl.GlCommands.get().glNamedFramebufferTexture(this.getGlId(), attachmentPoint, attachment.getGlId(), 0);
        } else if (attachment instanceof RenderBuffer) {
            de.florianmichael.thingl.GlCommands.get().glNamedFramebufferRenderbuffer(this.getGlId(), attachmentPoint, attachment.getTarget(), attachment.getGlId());
        } else {
