...
public abstract class SDLApplicationRunner extends ApplicationRunner {
    ...
    protected void setGLAttributes() {
        ...
        SDLErrorUtil.checkError(SDLVideo.SDL_GL_SetAttribute(SDLVideo.SDL_GL_CONTEXT_MINOR_VERSION, de.florianmichael.thingl.GlCommands.isApple() ? 1 : 5)); // FlorianMichael - add macOS support
